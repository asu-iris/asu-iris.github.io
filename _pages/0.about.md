...
Welcome to **Intelligent Robotics and Interactive Systems (IRIS)** Lab! Our research focuses on

- **Contact-rich manipulation:** Our goal is to equip multi-fingered robotic hands with the ability to manipulate diverse objects as skillfully as humans. To achieve this, we build a physics-grounded, bidirectional approach: learning (AI) methods provide in-the-wild top-down intelligence, while physics-based methods deliver reliable, efficient, adaptive support from the bottom-up.

- **Autonomy alignment with human feedback:** Our goal is to make the acquisition of robot autonomy as easy and efficient as possible, such as robot learn from human's sparse demonstration, directional physical correction, preferences. Therefore, we develop certifiable, efficient, and empowering methods to enable robots to learn and improve their autonomy from daily human users through various natural interactions.

- **Control and optimization methods:** We also design fundamental methods and algorithms for general autonomous systems to ensure efficient and safe operation. Our approach leverages tools from optimal control, differentiable optimization, and reinforcement learning.
