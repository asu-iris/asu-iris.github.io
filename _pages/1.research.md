...
The IRIS lab focuses on the following reserach topics: **(1) systems with human-on-the-loop**, **(2) contact-rich (dexterous) manipulation**,  and **(3) fundamental robotics: control/optimization/machine Learning**. Below are some recent publications in each set of research interest.
...
<ul>
  <li><strong>Learning in human-robot interactions</strong> </li>
