...
The IRIS lab focuses on the following reserach topics: **(1) systems with human-on-the-loop**, **(2) contact-rich (dexterous) manipulation**,  and **(3) fundamental research**. Below are some recent publications in each set of research interest.
...
<div class="title" onclick="toggleFoldableSection(this)">Systems with Human-On-The-Loop</div>
<div class="content">

We study how an autonomous system understands and is understood by a user, and how it properly reponds and works with a user.

<p style="margin-bottom:0.3cm; margin-left: 1.5cm"> </p>

<ul>
  <li><strong>Learning from general human interactions</strong> </li>
  <li><strong>Planning and control for human-machine systems</strong></li>
</ul>
...
We study how an autonomous system touches and affects the physical world in a safe and skillful manner.
...
<div class="foldable-section">
<div class="title" onclick="toggleFoldableSection(this)">Fundamental Research</div>
<div class="content">

We develop foundational theorems/algorithms/systems to enable and verify system intelligence.
