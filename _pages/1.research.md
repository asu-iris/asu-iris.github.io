...
We develop efficient physics-based representations/modeling, planning/control methods to enable robots to gain real-time and efficient dexterity: through frequently making or breaking contacts with objects
  ...
  <ul>
    ...
    <li><strong>Computer vision and sensor fusion for dexterous manipulation</strong></li>
  </ul>
  <hr />
