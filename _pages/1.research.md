...
<div class="content">
  ...
  <ul>
    <li><strong>Multi-Contact modeling and simulation</strong></li>
    <li><strong>Learning, planning, and control for contact-rich manipulation</strong></li>
    <li><strong>Multisensory perception in dexterous manipulation</strong></li>
  </ul>
  <hr />
...
<!-- We develop certifiable, efficient, and empowering methods to enable robots to align their autonomy with human users through various natural interactions. -->
  ...
  <ul>
    <li><strong>Learning from demonstrations</strong> </li>
    <li><strong>Learning from interactions</strong></li>
  </ul>
  <hr />
