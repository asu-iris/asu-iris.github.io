...
<div class="update-item">
    ...
    <div class="update-content">
      ...
      <p>
        🚀🚀 Tracking unknown, highly dynamic objects in <strong>contact-rich scenes</strong>  — falling, bouncing, in-hand manipulation? Occlusion, blur, and impacts make it tough. Introducing 🔥🔥<a href="https://irislab.tech/TwinTrack-webpage/" target="_blank"><u>TwinTrack</u></a>🔥🔥: a physics-aware, <strong><u>real-time</u></strong> (>20 Hz) tracker that fuses <strong><u>Real2Sim</u></strong>  + <strong><u>Sim2Real</u></strong>, bridging vision and contact physics for reliable tracking. All GPU-accelerated!
      </p>
      ...
      <ul style="font-size: 1rem; line-height: 1.6; padding-left:0">
        <li>🧠 <strong>Real2Sim</strong>: infers object geometry & physical properties from vision + contact cues</li>
        <li>👁️ <strong>Sim2Real</strong>: predicts motion via contact dynamics, fused with visual tracking</li>
        <li>💪 Robust to occlusion, blur, and impacts — no prior object model required</li>
        <li>🚀 GPU-accelerated and runs in real time at >20 Hz</li>
      </ul>
...
<div class="update-item">
    <div class="update-date">May 1, 2025</div>
      <div class="update-content">
      <p>
         ㊗️ 🎉: Our paper <a href="https://arxiv.org/abs/2502.02921" target="_blank">“Robust Reward Alignment via Hypothesis Space Batch Cutting”</a> has been accepted to International Conference on Machine Learning (ICML) 2025. Congrats to <a href="https://zhi-xian-xie.github.io/" target="_blank">Zhixian Xie,</a>  Haode Zhang, and Yizhe Feng!
      </p> 
...
<div class="update-item">
    <div class="update-date">Apr. 11, 2025</div>
      <div class="update-content">
      <p>
         ㊗️ 🎉: Our paper <a href="https://arxiv.org/pdf/2408.07855" target="_blank">“Complementarity-Free Multi-Contact Modeling and Optimization for Dexterous Manipulation”</a> has been accepted to Robotics: Science and Systems (RSS) 2025. Congrats!
      </p> 
        See our previous  
        <a  href="https://x.com/jinwanxin/status/1825958958382854247" target="_blank" role="button"> <i class="fa-brands fa-twitter fa-shake"></i> 𝕏-Twitter </a> and 
...
<div class="update-item">
    <div class="update-date">Feb. 16, 2025</div>
      <div class="update-content">
      <p>
         ㊗️ 🎉: Wen's paper <a href="https://arxiv.org/abs/2408.09612" target="_blank">“ContactSDF: Signed Distance Functions as Multi-Contact Models for Dexterous Manipulation”</a> has been accepted to RA-L. Congrats to Wen!
      </p> 
        See our previous  
        <a  href="https://x.com/jinwanxin/status/1828130385806651428" target="_blank" role="button"> <i class="fa-brands fa-twitter fa-shake"></i> 𝕏-Twitter </a> and 
...
<div class="update-item">
    ...
    <div class="update-content">
      ...
      <p>
      Can model-based planning and control rival or even surpass reinforcement learning in challenging dexterous manipulation tasks? Our answer is a resounding YES! PROUD to share: 🔥🔥<a href="https://arxiv.org/abs/2408.07855" target="_blank">"Complementarity-Free Multi-Contact Modeling and Optimization,"</a>,  our latest method that sets shattering benchmarks in various challenging dexterous manipulation tasks.
      </p>
